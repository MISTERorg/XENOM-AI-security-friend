...
engine.setProperty('voice', voices[tone].id+"+f5")
...
def greeting():
    ...
    if calls == 0:
        ...
        greet = ["oui parle, tu sais que tu peux tout me demander", "je te suis", "parle je t'écoute", "je suis la parle", "oui a ton service", "parle"]
